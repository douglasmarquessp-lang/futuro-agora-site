...
export const metadata: Metadata = {
  title: 'Política de Privacidade — FuturoAgora.tech',
  description: 'Leia a nossa Política de Privacidade para entender como o FuturoAgora.tech coleta, protege e trata os seus dados pessoais de acordo com a LGPD.',
  alternates: {
    canonical: 'https://futuroagora.tech/politica-de-privacidade',
  },
};
    ...
    <div className="page" style={{ marginTop: '40px', maxWidth: '800px', background: '#fff', padding: '30px', border: '2.5px solid var(--ink)', borderRadius: '6px', marginBottom: '40px' }}>
      ...
      <div style={{ lineHeight: '1.8', fontSize: '1rem', color: 'var(--ink)' }}>
        ...
        <p style={{ marginBottom: '15px' }}>
          Última atualização: maio de 2026<br />
