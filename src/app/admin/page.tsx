...
async function createArticleAction(formData: FormData) {
  ...
  const imageUrl = formData.get('imageUrl') as string; // Adicionado
  ...
  await db.article.create({
    data: {
      ...
      category,
      emoji,
      imageUrl: imageUrl || null, // Adicionado
      readTime,
      isFeatured,
      isTrending,
    },
        ...
        <div className="col-main" style={{ padding: '30px', background: '#fff' }}>
          ...
          <form action={createArticleAction}>
            ...
            <div className="form-group">
              ...
              <input type="text" name="imageUrl" className="form-input" placeholder="ex: https://site.com/foto.jpg" />
            </div>
